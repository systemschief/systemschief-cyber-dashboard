...
export default function Image() {
  return new ImageResponse(
    <div style={{ width: '100%', height: '100%', background: '#0a0d0f', color: '#e6edf3', display: 'flex', flexDirection: 'column', padding: 64, border: '1px solid rgba(255,255,255,.08)' }}>
      ...
      <div style={{ marginTop: 72, fontSize: 76, lineHeight: .92, fontFamily: 'monospace', textTransform: 'uppercase', letterSpacing: -2, maxWidth: 980, textShadow: '0 0 22px rgba(57,255,122,.1)' }}>The Threat Landscape, In Real Time.</div>
